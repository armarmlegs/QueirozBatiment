...
import { PicsTourMaubourg } from "../../components/GridData";
    ...
    <>
      ...
      <Container>
        <OpRow>
          <OpColumn1>
            <OpTextWrapper>
              <OpHeading>Tour-Maubourg – Paris 7</OpHeading>
              ...
              <OpTopLine>
                Rénovation totale d’un appartement de 180 m2.
              </OpTopLine>
            </OpTextWrapper>
          </OpColumn1>
        </OpRow>
      ...
      <GridWrapper>
        <GridGallery dataImg={PicsTourMaubourg} />
      </GridWrapper>
